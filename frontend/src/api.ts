...
const API_URL = process.env.REACT_APP_API_URL || "https://smcanalisys-production-4d47.up.railway.app";
...
export const statsAPI = {
  getSignalStats: () => apiClient.get("/stats/signals"),
  getAllSignals: () => apiClient.get("/stats/all-signals"),
};

// Demo/Mock data - REMOVIDO para usar apenas dados reais
// Os dados de demo foram removidos para garantir que apenas dados reais sejam exibidos
